<template>
    ...
    <div id="news">
    	...
    	<h1>{{ $t('common.newss') }}</h1>
    	<nav>
			<ui-icon-button @click="decPage" icon="chevron_left" type="primary" class="buttonLeft"></ui-icon-button>
			<ui-icon-button @click="incPage" icon="chevron_right" type="primary" class="buttonRight"></ui-icon-button>
		</nav>
