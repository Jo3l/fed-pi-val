...
export default {
		...
		return {			addToSchema: '',
					        ...
					        schemaa: {
					            fields: [{
					                ...
					                min: 6,
					                required: true,
					                hint: "Minimo {1} characters",
					                validator: VueFormGenerator.validators.string.locale({
								        fieldIsRequired: "El password es necesario!",
								        textTooSmall: "El passwd al menos debe tener {1} characters"
								    })
					            }, {
					                type: "input",
					                inputType: "number",
	...
	methods: {
		add: function() {
			console.log(this.addToSchema);
			this.schema.fields.push({
					                type: this.addToSchema,
									inputType: "text",
					                label: "Name",
					                model: "name",
					                readonly: false,
